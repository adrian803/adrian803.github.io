...
**VuePresss+GitHub Pages+picgo+腾讯云对象存储+任意Markdown编辑器 ~~（个人推荐[Typora](https://typora.io/)~~(89永久自行取舍个人觉得值得因为这款笔记软件很好用),[Obsidian](https://obsidian.md/),[Yank Note](https://yanknote.com/)+git**
