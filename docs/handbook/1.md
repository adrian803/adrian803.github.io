...
**VuePresss+GitHub Pages+picgo+腾讯云对象存储+任意Markdown编辑器 （个人推荐[Typora](https://typora.io/),[Obsidian](https://obsidian.md/),[Yank Note](https://yanknote.com/))+git**
...
- 安装并部署你的 Git  
    下载并安装相关的程序，运行并配置你的账户。你可以根据廖雪峰老师的这个教程来安装。[廖雪峰的官方网站-安装Git(opens new window)](https://www.liaoxuefeng.com/wiki/896043488029600/896067074338496)
- 建立本地和远程仓库的连接  
